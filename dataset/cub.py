...
class CUBirds(BaseDataset):
    def __init__(self, root, mode, transform=None):
        ...
        self.path_train_n_2 = self.root + '/train_n_2'
        self.path_eval_n_2 = self.root + '/valid_n_2'
        self.path_train_n_3 = self.root + '/train_n_3'
        self.path_eval_n_3 = self.root + '/valid_n_3'

        if self.mode == 'train_0':
            self.classes = range(0, 140)
        ...
        elif self.mode == 'train_2':
            # self.classes = range(0, 200)
            self.path = self.path_train_n_2

        elif self.mode == 'train_3':
            # self.classes = range(0, 200)
            self.path = self.path_train_n_3
        ...
        elif self.mode == 'eval_2':
            self.classes = range(0, 180)
            self.path = self.path_eval_n_2

        elif self.mode == 'eval_3':
            self.classes = range(0, 200)
            self.path = self.path_eval_n_3
